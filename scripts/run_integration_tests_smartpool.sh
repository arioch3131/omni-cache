...
# This script runs integration tests for the smartpool adapter.
...
TEST_DIR="$PROJECT_ROOT/tests/integration/adapters/smartpool/"
...
print_header "Running Integration Tests for smartpool Adapter"
...
print_header "smartpool Adapter Integration Tests Passed Successfully!"
echo -e "${COLOR_GREEN}Code coverage for smartpool adapter is above ${COVERAGE_THRESHOLD}%.${COLOR_NC}"
