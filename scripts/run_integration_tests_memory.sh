...
# This script runs integration tests for the memory adapter.
...
SOURCE_DIR="$PROJECT_ROOT/src/omni_cache/adapters/memory/"
TEST_DIR="$PROJECT_ROOT/tests/integration/adapters/memory/"
...
print_header "Running Integration Tests for memory Adapter"
...
print_header "memory Adapter Integration Tests Passed Successfully!"
echo -e "${COLOR_GREEN}Code coverage for memory adapter is above ${COVERAGE_THRESHOLD}%.${COLOR_NC}"
