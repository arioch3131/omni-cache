...
# This script runs performance tests for the smartpool adapter.
...
TEST_DIR="$PROJECT_ROOT/tests/performance/adapters/smartpool/"
...
print_header "Running Performance Tests for smartpool Adapter"
echo "Running pytest for $TEST_DIR..."
pytest "$TEST_DIR"

print_header "smartpool Adapter Performance Tests Completed Successfully!"
echo -e "${COLOR_GREEN}All performance tests for smartpool adapter ran without errors.${COLOR_NC}"
