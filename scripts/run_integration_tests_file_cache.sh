...
# This script runs integration tests for the file_cache adapter.
...
SOURCE_DIR="$PROJECT_ROOT/src/omni_cache/adapters/file_cache/"
TEST_DIR="$PROJECT_ROOT/tests/integration/adapters/file_cache/"
...
print_header "Running Integration Tests for file_cache Adapter"
...
print_header "file_cache Adapter Integration Tests Passed Successfully!"
echo -e "${COLOR_GREEN}Code coverage for file_cache adapter is above ${COVERAGE_THRESHOLD}%.${COLOR_NC}"
