...
# This script runs performance tests for the redis adapter.
...
TEST_DIR="$PROJECT_ROOT/tests/performance/adapters/redis/"
...
print_header "Running Performance Tests for redis Adapter"
echo "Running pytest for $TEST_DIR..."
pytest "$TEST_DIR"

print_header "redis Adapter Performance Tests Completed Successfully!"
echo -e "${COLOR_GREEN}All performance tests for redis adapter ran without errors.${COLOR_NC}"
